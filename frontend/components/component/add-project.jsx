...
export function AddProject({ openModal }) {
  ...
  const [githubRepoLink, setGithubRepo] = useState();


  const submitHandler = async (e) => {
    e.preventDefault();
    console.log(githubRepoLink);
    const project = {name: projectName, description, tags, githubRepoLink};
    ...
    <div
      ...
      <form className="space-y-4">
        ...
        <div>
          ...
          <Input defaultValue={githubRepoLink} id="githubRepo" type="text" onChange={(e) => setGithubRepo(e.target.value)}/> {}
        </div>
